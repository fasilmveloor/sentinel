...
class OWASPBenchmarkImporter:
    ...
    def __init__(self, csv_path: str | None = None, use_cache: bool = True):
...
class CrAPIImporter:
    ...
    def __init__(self, openapi_path: str | None = None, use_cache: bool = True):
...
class JuiceShopImporter:
    ...
    def __init__(self, challenges_path: str | None = None, use_cache: bool = True):
