...
from .models import AIAttackDecision, AttackType, Endpoint, HttpMethod, LLMProvider
    ...
    def _initialize(self):
        if self.model is None:
            try:
                ...
                raise AIAgentError("google-generativeai not installed. Run: pip install google-generativeai") from err
    ...
    def _initialize(self):
        if self.client is None:
            try:
                ...
                raise AIAgentError("openai not installed. Run: pip install openai") from err
    ...
    def _initialize(self):
        if self.client is None:
            try:
                ...
                raise AIAgentError("anthropic not installed. Run: pip install anthropic") from err
...
Be efficient - only recommend relevant attacks. Not all endpoints need all tests."""
    ...
    def _init_providers(self, api_key: str | None):
    ...
    def _get_active_provider(self, preferred: LLMProvider) -> BaseLLMProvider | None:
