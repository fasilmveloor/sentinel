...
class NoSQLInjectionAttacker:
    ...
    def create_vulnerability(
        ...
        return Vulnerability(
            ...
            description=(
                f"NoSQL injection vulnerability detected. The API endpoint "
                f"does not properly sanitize user input before using it in "
                f"NoSQL database queries (likely MongoDB). Attackers can "
                f"bypass authentication, extract data, or execute arbitrary "
                f"JavaScript code on the database server."
            ),
